            ...
            <div class="card-body">
                <form method="get" action="<?= base_url('admin/jurnal/jurnal') ?>">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_awal" id="tanggal_awal" value="<?= isset($tanggal_awal) ? $tanggal_awal : '' ?>">
                    </div>
                    <div class="form-group">
                        <label for="tanggal_akhir">Tanggal Akhir</label>
                        <input type="date" class="form-control" name="tanggal_akhir" id="tanggal_akhir" value="<?= isset($tanggal_akhir) ? $tanggal_akhir : '' ?>">
                    </div>
             ...
             <h4>Total Saldo: <?= format_rupiah($total_saldo) ?></h4>
            <!-- /.card-body -->
        </div>
        <!-- /.card -->
    </section>
